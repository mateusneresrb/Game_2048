...
public class TableBuilder {
     ...
     */
    public String build() {
        checkNotNull(borders, "Borders");
        checkNotNull(values, "Values");
        checkNotEmpty(values, "Values");
        check(Arrays.stream(values).allMatch((row) -> Arrays.stream(row).allMatch(Objects::nonNull)), "A value may not be null");
        check(padding >= 0, "Padding must not be < 0");
        ...
        check(values.length >= rows, "The amount of rows must not be smaller than specified in the row names");
        int oldColumns = columns;
        check(Arrays.stream(values).noneMatch((row) -> row.length < oldColumns), "The amount of columns must be consistent");
        ...
        if (autoAdjust) {
            ...
            check(check, "Length of values must not be longer than length of headers");
        }
     ...
     *
     * @param rows The row names as varargs, so either a String[] or single Strings.
     * @return This builder.
    ...
    /**
     * Sets the borders for this table using the nested {@link Borders Borders} class.
     *
     * @param borders An instance of the Borders class that specifies the characters to use.
     * @return This builder.
     */
     ...
     *
     * @param tableName The name of the table as a String. Default: empty String
     * @return This builder.
     ...
     * <br>By default, this is set to {@link Alignment#CENTER CENTER}.
     *
    ...
    public static class Borders {
         ...
         *
         * @param rowDelimiter                 The character used to separate normal rows from each other
         * @param columnDelimiter              The character used to separate normal columns form each other
         * @param crossDelimiter               The character to be placed where the vertical and horizontal lines inside the table cross
         * @param leftIntersection             The character for frame intersections at the left
         * @param rightIntersection            The character for frame intersections at the right
         * @param upperIntersection            The character for upper frame intersections
         * @param lowerIntersection            The character for lower frame intersections
         * @param upLeftCorner                 The character for the upper left frame corner
         * @param upRightCorner                The character for the upper right frame corner
         * @param lowLeftCorner                The character for the lower left frame corner
         * @param lowRightCorner               The character for the lower right frame corner
         * @param headerDelimiter              The normal character to be placed between the first row and the second row
         * @param headerCrossDelimiter         The character to be placed where the header delimiter and the column delimiters cross
         * @param headerLeftIntersection       The character to be placed at the very left of the header delimiter
         * @param headerRightIntersection      The character to be placed at the very right of the header delimiter
         * @param firstColumnDelimiter         The normal character to be placed between the first and the second column
         * @param firstColumnCrossDelimiter    The character to be placed after the first column where the row delimiters are crossed
         * @param firstColumnUpperIntersection The character to be placed at the very top of the first column delimiter
         * @param firstColumnLowerIntersection The character to be placed at the very bottom of the first column delimiter
         * @param headerColumnCrossDelimiter   The character to be placed at the intersection first row x first column
         * @param horizontalOutline            The character to use for the upper and lower frame outline
         * @param verticalOutline              The character to use for the left and right frame outline
         */
    ...
    private static void checkNotEmpty(Object[] array, String name) {
        check(array.length > 0, name + " must not be empty");
    }
